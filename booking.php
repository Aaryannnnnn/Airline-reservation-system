...
$query = "update booking set b_datetime='$b_datetime',flightno='$flightno',from_city='$from_city',to_city='$to_city',total_amt=$total_amt,transaction_id='$transaction_id' where username='$u'";
$n = my_iud($query);
